...
use super::model::{DEFAULT_MEM_WORDS, MajorPayload, TileColumns};
...
mod tests {
    use super::{
        apply_memory_init_words, bits_to_words, hex_words_to_u32s, parse_binary_literal,
        parse_hex_literal, parse_init_payload_words, reverse_groups,
    };
    use crate::{
    ...
    fn build_memory_payloads_orders_tiles_by_arch_bit_position() {
        ...
        let payloads =
            super::build_memory_payloads(&cil, &arch, Some(&programming)).expect("payloads");
